...
public class AssistantSessionCreateTest extends TestHarness {
	...
	public void test200Negative(final int tutorialIndex, final String title, final String sessionAbstract, final String indication, final String periodStart, final String periodEnd, final String link) {
	...
	public void test300Hacking() {
		...
		for (final Tutorial t : tutorials) {
			...
			super.request("/assistant/session/create", query);
